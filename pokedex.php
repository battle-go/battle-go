    ...
    <article>
      ...
      <table style="background-color: #ccc">
        ...
        <tr>
          ...
          <td> <?php if ($user['id'] == $pokemon['user_id']) { echo '<img src="picture\possede & non possede\possede.gif" />', '<img src="pokemons/151.gif" />' ; }   else { echo '<img src="picture\possede & non possede\pokeba10.png" /> <img src="picture\possede & non possede\Sprite_3_f_--.png" />'; } ?></td>
